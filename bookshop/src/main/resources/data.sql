...
VALUES 
(1, 'Java: Руководство для начинающих', 2014, 90000, now(), '79650.jpg'),
(2, 'Грамматика: сборник упражнений', 2002, 30000,  now(), 'zno_angliyska1.jpg'),
(3, 'Случайная вакансия', 2016, 12000, now(), 'azbuka_9785389079878_images_2140869641.jpg'),
(4, 'Harry Potter and the Philosophers Stone', 2014, 45000, now(), '54829080_images_12099178356.jpg'),
(5, 'Sapiens. Краткая история человечества', 2002, 15000, now(), '78677876_images_11494291616.jpg'),
(6, 'Хранители', 2012, 78000,  now(), '6498520_images_1417882113.jpg'),
(7, 'Атлант розправив плечі. Комплект з трьох книг у футлярі',  2002,  142000, now(), 'nash_format_9786177279357_images_11294607738.jpg'),
(8, 'Гравити Фолз. ежеДНЕВНИК', 2002,  33000,now(), '71496220_images_10775113012.jpg'),
(9, 'Зеленая миля', 2002,  130000, now(), '6496168_images_1412822470.jpg'),
(10, 'Шантарам', 2002,  3000, now(), '63063558_images_8942912781.jpg');
